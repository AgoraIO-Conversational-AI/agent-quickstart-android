...
val WarmForeground = Color(0xFF0F172A)
val WarmCard = Color(0xFFFFFFFF)
val WarmPrimary = Color(0xFF2563EB)
val WarmPrimaryForeground = Color(0xFFFFFFFF)
val WarmMuted = Color(0xFFEFF6FF)
val WarmMutedForeground = Color(0xFF64748B)
val WarmBorder = Color(0xFFE2E8F0)
val WarmSuccess = Color(0xFF14B8A6)
val WarmDestructive = Color(0xFFDC2626)
val WarmWarning = Color(0xFFF97316)
val WarmSidebar = Color(0xFFFFFFFF)
val WarmSidebarBorder = Color(0xFFE2E8F0)
